...
function findInstalledCodexAcpBin() {
  ...
  const baseDirs = [
    ...
    "/usr/lib/node_modules/@openclaw/codex",
  ];
...
const installedBinPath = findInstalledCodexAcpBin();
const packageVersion = process.env.OPENCLAW_CODEX_ACP_VERSION || "0.16.0";
let defaultCommand;
let defaultArgs;
if (installedBinPath) {
  ...
  defaultArgs = [
    ...
    "--yes",
    "--package",
    `@zed-industries/codex-acp@${packageVersion}`,
    "--",
    "codex-acp",
  ];
} else {
